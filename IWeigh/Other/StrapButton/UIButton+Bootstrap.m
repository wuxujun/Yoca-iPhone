...
-(void)greenStyle{
    ...
    self.backgroundColor = [UIColor colorWithRed:60/255.0 green:193/255.0 blue:102/255.0 alpha:1];
    self.layer.borderColor = [[UIColor blackColor] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:60/255.0 green:196/255.0 blue:102/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
