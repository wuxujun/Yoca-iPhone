...
@protocol IValueTrackingSliderDelegate;
@protocol IValueTrackingSliderDataSource;

@interface IValueTrackingSlider : UISlider
...
@property (weak, nonatomic) id<IValueTrackingSliderDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<IValueTrackingSliderDelegate> delegate;
@end
...
@protocol IValueTrackingSliderDataSource <NSObject>
- (NSString *)slider:(IValueTrackingSlider *)slider stringForValue:(float)value;
@end
...
@protocol IValueTrackingSliderDelegate <NSObject>
- (void)sliderWillDisplayPopUpView:(IValueTrackingSlider *)slider;

@optional
- (void)sliderWillHidePopUpView:(IValueTrackingSlider *)slider;
- (void)sliderDidHidePopUpView:(IValueTrackingSlider *)slider;
@end
