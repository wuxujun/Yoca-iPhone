...
@interface IValueTrackingSlider() <IValuePopUpViewDelegate>
@property (strong, nonatomic) IValuePopUpView *popUpView;
@property (nonatomic) BOOL popUpViewAlwaysOn; // default is NO
@end

@implementation IValueTrackingSlider
{
...
- (void)setup
{
    ...
    self.popUpView = [[IValuePopUpView alloc] initWithFrame:CGRectZero];
